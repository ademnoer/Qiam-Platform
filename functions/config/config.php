...
define("COOKIE_DOMAIN", "c");
define("COOKIE_SECRET_KEY", "SDFG%%he4gsTJtsjs5ujEF$^Je4ge5e#%$235");
...
define("EMAIL_SMTP_AUTH", true);
define("EMAIL_SMTP_USERNAME", "info@qiam-platform.org");
define("EMAIL_SMTP_PASSWORD", "Oalgorani@2016");
define("EMAIL_SMTP_PORT", 465);
define("EMAIL_SMTP_ENCRYPTION", "ssl");
